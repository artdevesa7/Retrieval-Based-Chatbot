...
response_a = "The symptoms of Diabetes are insulin resistance, weight gain, and iregular appetite"
response_b = "The flu symptoms goes away on its own after a couple of days."
response_c = "Headaches are caused by many posibilities. One is that the headache is caused by stress"
